...
#import "JKPickBySlideRangeDelegate.h"

NS_ASSUME_NONNULL_BEGIN

IB_DESIGNABLE
@interface JKPickBySlideRange : UIControl

/**
 * Optional delegate.
 */
@property (nonatomic, weak) IBOutlet id<JKPickBySlideRangeDelegate> delegate;
